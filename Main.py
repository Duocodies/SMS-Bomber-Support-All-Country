...
def start():
    banner = pyfiglet.figlet_format("Black Virus")
    print(Fore.RED)
    ...
    while iteration < count:
        ...
        try:
            ...
            print(nice + "sent successfully!" + Style.RESET_ALL)
        except:
            print(fail + "Failed!о" + Style.RESET_ALL)
        try:
            requests.get(
...
def menu():
    ...
    banner = pyfiglet.figlet_format("Duo Codies")
    print(Fore.YELLOW)
    print(banner + Style.RESET_ALL)
    print(Fore.GREEN + '-------------------------------')
    print(
        Fore.GREEN +
        '''Created by Duocodies\nWebsite: Duocodies.cyou\nversion 1.1'''
    )
    print('-------------------------------')
    global phone
